...
public class BaseClass 
{
	...
	//1
	public static WebDriver setBrowser(String browser) throws InterruptedException 
	{
		try 
		{
	...
	*/
	...
	public static void takeScreenshot() throws IOException 
	{
		...
		File target = new File("C:\\Users\\Abishek Raj\\eclipse-workspace\\Adactin\\Screenshots");
